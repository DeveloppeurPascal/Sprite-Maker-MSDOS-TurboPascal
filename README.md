...
Editor for sprites stored in SPR format files.

Created in 1992 for use on video games developed in [Turbo Pascal](https://en.wikipedia.org/wiki/Turbo_Pascal) for MS-Dos.
